...
export default function ZoomYoyo() {
  return (
    <ProjectPage title="Zoom Yoyo Manufacturing" subtitle="2.008 Design and Manufacturing II, 2021">
      ...
      <figure className="my-8 flex gap-2 items-stretch" style={{ height: 'clamp(220px, 32vw, 340px)' }}>
        <div className="flex flex-col flex-1 min-w-0 h-full">
          <img src="/images/zoom-yoyo/cap.png" alt="" className="w-full flex-1 min-h-0 object-contain my-0" />
          <img src="/images/zoom-yoyo/thermo.png" alt="" className="w-full flex-1 min-h-0 object-contain my-0" />
        </div>
        <div className="flex-1 min-w-0 self-stretch overflow-hidden">
          <img src="/images/zoom-yoyo/20210407_122919.jpg" alt="" className="w-full h-full object-cover object-center" />
        </div>
      </figure>
