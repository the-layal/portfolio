      ...
      {ICON_GRID_IMAGES.map(({ file, caption }) => (
        ...
        >
          <img
            ...
            alt=""
            onClick={() => open(`/images/social-robot/${file}`, caption)}
            style={{
              width: 96,
              height: 96,
              objectFit: 'contain',
...
export default function SocialRobot() {
  return (
    <ProjectPage title="Social Robot Research Study" subtitle="MIT Media Lab, 2019">
      ...
      <LightboxImage src="/images/social-robot/fb5d188bee22f8a634469a17657f890d.png" alt="" style={{ maxWidth: '100%' }} />
      <h3>{`The Icons`}</h3>
      ...
      <LightboxImage src="/images/social-robot/draft-icons-page-001-e1577690159976.jpg" alt="" style={{ maxWidth: '100%' }} />
      <LightboxImage src="/images/social-robot/draft-icons-page-002-e1577687584598.jpg" alt="" style={{ maxWidth: '100%' }} />
      <p>{`After this, it was time to move onto computerizing everything with Adobe Illustrator. Some icons had multiple iterations, and we wanted to see what they would look like digitized before making a decision. Here are just a few icon designs we had to decide between:`}</p>
      ...
      <LightboxImage src="/images/social-robot/reference-sheet-final-page-001-e1577690114427.jpg" alt="" style={{ maxWidth: '100%' }} />
      ...
      <LightboxImage src="/images/social-robot/20190716_113345-e1577845647848.jpg" alt="" style={{ maxWidth: '100%' }} />
      ...
      <LightboxImage src="/images/social-robot/20190710_091932.jpg" alt="" style={{ maxWidth: '100%' }} />
      <LightboxImage src="/images/social-robot/20190710_092406.jpg" alt="" style={{ maxWidth: '100%' }} />
      <LightboxImage src="/images/social-robot/20190710_102256-e1577847458769.jpg" alt="" style={{ maxWidth: '100%' }} />
      ...
      <LightboxImage src="/images/social-robot/20190708_115141-e1577849387891.jpg" alt="" style={{ maxWidth: '100%' }} />
