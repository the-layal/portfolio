  ...
  return (
    <ProjectPage title="How to Design Intensive" subtitle="MIT, 2020">
      <div className="not-prose sm:hidden flex flex-col gap-[9px]">
        <img src="/images/design-intensive/barakat_layal_how-to-design_assignment-01-1.png" alt="Assignment 1 final piece" className="w-full h-auto cursor-zoom-in" onClick={() => open('/images/design-intensive/barakat_layal_how-to-design_assignment-01-1.png', 'Assignment 1 final piece')} />
        <img src="/images/design-intensive/spin-loop.gif" alt="Spin-loop animation from Assignment 2 process" className="w-full h-auto cursor-zoom-in" onClick={() => open('/images/design-intensive/spin-loop.gif', 'Spin-loop animation from Assignment 2 process')} />
      </div>
      <figure className="not-prose hidden sm:block relative overflow-hidden">
        ...
        <div className="absolute inset-0 flex gap-[9px]">
          <img src="/images/design-intensive/barakat_layal_how-to-design_assignment-01-1.png" alt="Assignment 1 final piece" className="h-full w-full object-cover min-w-0 cursor-zoom-in" style={{ flex: 2000/1125 }} onClick={() => open('/images/design-intensive/barakat_layal_how-to-design_assignment-01-1.png', 'Assignment 1 final piece')} />
          <img src="/images/design-intensive/spin-loop.gif" alt="Spin-loop animation from Assignment 2 process" className="h-full w-full object-cover min-w-0 cursor-zoom-in" style={{ flex: 298/480 }} onClick={() => open('/images/design-intensive/spin-loop.gif', 'Spin-loop animation from Assignment 2 process')} />
        </div>
      </figure>
      ...
      <LightboxImage src="/images/design-intensive/ideas.png" alt="" />
