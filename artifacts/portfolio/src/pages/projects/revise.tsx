...
export default function ReVise() {
  ...
  return (
    <ProjectPage title="ReVise: A Conformable Vise" subtitle="2.009 Product Design Process, 2021">
      <LightboxImage src="/images/revise/mainimage.png" alt="" />
      ...
      <LightboxImage src="/images/revise/20211005_144021.jpg" alt="" />
      ...
      <LightboxImage src="/images/revise/20211019_205602.jpg" alt="" />
      ...
      <LightboxImage src="/images/revise/52la96_as01.png" alt="" />
      ...
      <LightboxImage src="/images/revise/20211021_112055.jpg" alt="" />
      <p>{`The prototype, which we named Conform, finally took shape as shown below:`}</p>
      <LightboxImage src="/images/revise/pinkb2-1.jpg" alt="" />
      ...
      <LightboxImage src="/images/revise/storyboard.jpg" alt="" />
      ...
      <figure className="my-8 flex justify-center not-prose">
        <img src="/images/revise/pinkteamwave.gif" alt="" className="max-w-full h-auto rounded cursor-zoom-in" onClick={() => open('/images/revise/pinkteamwave.gif')} />
      </figure>
    </ProjectPage>
  );
}
